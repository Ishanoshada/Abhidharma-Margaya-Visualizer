...
const MARANASANNA_EXAMPLES = [
    {
        ...
        steps: [
            { pali: 'Atīta Bhavaṅga', cittaId: 'bhavanga', story: { en: 'Past Life-Continuum: The normal, passive flow of consciousness maintaining life.', si: 'අතීත භවාංග: ජීවිතය පවත්වාගෙන යන විඥනයේ සාමාන්‍ය, නිෂ්ක්‍රීය ප්‍රවාහය.', ta: 'கடந்தகால வாழ்க்கை-தொடர்ச்சி: வாழ்க்கையை பராமரிக்கும் உணர்வின் சாதாரண, செயலற்ற ஓட்டம்.', hi: 'अतीत भवंग: जीवन को बनाए रखने वाली चेतना का सामान्य, निष्क्रिय प्रवाह।' } },
            { pali: 'Bhavaṅga-calana', cittaId: 'bhavanga', story: { en: 'Vibrating Bhavaṅga: The life-continuum is disturbed by the impending death event.', si: 'භවාංග චලන: එළඹෙන මරණ සිදුවීමෙන් ජීවිත-ቀጣይነት කැලඹී ඇත.', ta: 'அதிரும் பவங்கம்: வரவிருக்கும் மரண நிகழ்வால் வாழ்க்கை-தொடர்ச்சி கலங்குகிறது.', hi: 'कंपमान भवंग: आसन्न मृत्यु की घटना से जीवन-प्रवाह बाधित होता है।' } },
            { pali: 'Bhavaṅga-upaccheda', cittaId: 'bhavanga', story: { en: 'Arrested Bhavaṅga: The life-continuum stream is cut off, preparing the mind for the final object.', si: 'භවාංග උපච්ඡේද: ජීවිත-ቀጣይነት ගලායාම කපා හැර, අවසාන වස්තුව සඳහා මනස සූදානම් කරයි.', ta: 'தடைபட்ட பவங்கம்: வாழ்க்கை-தொடர்ச்சி ஓட்டம் துண்டிக்கப்பட்டு, இறுதிப் பொருளுக்கு மனதைத் தயார்படுத்துகிறது.', hi: 'अवरुद्ध भवंग: जीवन-प्रवाह रुक जाता है, मन को अंतिम वस्तु के लिए तैयार करता है।' } },
            { pali: 'Pañca-dvārāvajjana', cittaId: 'pancadvaravajjana', story: { en: 'Five-Door Adverting: The mind turns towards the sense doors. In this case, the eye-door.', si: 'පංචද්වාරාවජ්ජන: සිත ඉන්ද්‍රිය දොරටු වෙත යොමු වේ. මෙහිදී, චක්ෂු ද්වාරය වෙත.', ta: 'ஐந்து-வாசல் அறிதல்: மனம் புலன் வாசல்களை நோக்கித் திரும்புகிறது. இந்த நிலையில், கண்-வாசலை நோக்கி.', hi: 'पंच-द्वार आवर्जन: मन इंद्रिय द्वारों की ओर मुड़ता है। इस मामले में, चक्षु-द्वार की ओर।' } },
            { pali: 'Cakkhu-viññāṇa', cittaId: 'cakkhuvinnana', story: { en: 'Eye-Consciousness: Consciousness arises dependent on the eye, seeing a final karmic sign (Kamma Nimitta).', si: 'චක්ඛු විඤ්ඤාණ: ඇස මත පදනම්ව විඤ්ඤාණය හටගනී, අවසාන කර්ම නිමිත්තක් දකියි.', ta: 'கண்-உணர்வு: கண்ணைச் சார்ந்து உணர்வு எழுகிறது, ஒரு இறுதி கர்ம அடையாளத்தைக் காண்கிறது.', hi: 'चक्षु-विज्ञान: आंख पर निर्भर चेतना उत्पन्न होती है, जो एक अंतिम कर्म निमित्त को देखती है।' } },
            { pali: 'Sampaṭicchana', cittaId: 'sampaticchana', story: { en: 'Receiving Consciousness: The mind "receives" the sense object that was just seen.', si: 'සම්පටිච්ඡන: සිත දුටු ඉන්ද්‍රிய අරමුණ "ලබා ගනී".', ta: 'ஏற்கும் உணர்வு: மனம் இப்போது பார்த்த புலன் பொருளை "ஏற்கிறது".', hi: 'संप्रतिच्छन्न: मन अभी-अभी देखे गए इंद्रिय विषय को "प्राप्त" करता है।' } },
            { pali: 'Santīraṇa', cittaId: 'santirana', story: { en: 'Investigating Consciousness: The mind briefly examines the object.', si: 'සන්තීරණ: සිත කෙටියෙන් අරමුණ පරීක්ෂා කරයි.', ta: 'ஆராயும் உணர்வு: மனம் பொருளைச் சுருக்கமாக ஆராய்கிறது.', hi: 'संतिरण: मन संक्षेप में वस्तु की जांच करता है।' } },
            { pali: 'Votthapana', cittaId: 'votthapana', story: { en: 'Determining Consciousness: The mind determines the nature of the object, preparing for the decisive Javana phase.', si: 'වොත්ථපන: සිත අරමුණේ ස්වභාවය තීරණය කර, තීරණாत्मक ජවන් අවධිය සඳහා සූදානම් වේ.', ta: 'நிர்ணயிக்கும் உணர்வு: மனம் பொருளின் தன்மையை நிர்ணயித்து, தீர்க்கமான ஜவன கட்டத்திற்குத் தயாராகிறது.', hi: 'वोस्थापन: मन वस्तु की प्रकृति का निर्धारण करता है, निर्णायक जवन चरण के लिए तैयारी करता है।' } },
            { pali: 'Javana', cittaId: 'kusala', story: { en: 'Impulsion: A series of wholesome mind-moments that "enjoy" the object and seal the kamma for the next life.', si: 'ජවන්: අරමුණ "විඳින" සහ මීළඟ භවය සඳහා කර්මය මුද්‍රා තබන කුසල් සිත්-क्षण මාලාවක්.', ta: 'உந்துதல்: பொருளை "அனுபவித்து" அடுத்த வாழ்க்கைக்கு கர்மாவை முத்திரையிடும் நன்மை மன-கணங்களின் தொடர்.', hi: 'जवन: कुशल मन-क्षणों की एक श्रृंखला जो वस्तु का "आनंद" लेती है और अगले जीवन के लिए कर्म को सील करती है।' } },
            { pali: 'Cuti-citta', cittaId: 'cuti', story: { en: 'Death-Consciousness: The final mind-moment of this life, conditioned by the preceding Javana.', si: 'චුති චිත්ත: මෙම ජීවිතයේ අවසාන සිත්-क्षणය, පෙර පැවති ජවන් මගින් සකස් විය.', ta: 'மரண-உணர்வு: இந்த வாழ்க்கையின் இறுதி மன-கணம், முந்தைய ஜவனத்தால் நிபந்தனைக்குட்பட்டது.', hi: 'च्युति-चित्त: इस जीवन का अंतिम मन-क्षण, जो पूर्ववर्ती जवन द्वारा अनुकूलित होता है।' } },
            { pali: 'Paṭisandhi-citta', cittaId: 'patisandhi', story: { en: 'Rebirth-Linking Consciousness: The very first mind-moment of the new existence, immediately following Cuti.', si: 'පටිසන්ධි චිත්ත: චුතියෙන් පසු වහාම, නව පැවැත්මේ පළමු සිත්-क्षणය.', ta: 'மறுபிறப்பு-இணைப்பு உணர்வு: புதிய இருப்பின் முதல் மன-கணம், சுதியைத் தொடர்ந்து உடனடியாக.', hi: 'पटिसंधि-चित्त: नए अस्तित्व का पहला मन-क्षण, जो च्युति के तुरंत बाद आता है।' } },
        ]
    },
    {
        id: 'mind_door_dying',
        ...
        steps: [
            ...
            { pali: 'Bhavaṅga-upaccheda', cittaId: 'bhavanga', story: { en: 'Arrested Bhavaṅga: The formless life-stream is cut off, forced to process the new karmic object.', si: 'භවාංග උපච්ඡේද: අරූපී ජීවන ප්‍රවාහය කපා හැර, නව කර්ම නිමිත්ත සැකසීමට බල කෙරේ.', ta: 'தடைபட்ட பவங்கம்: உருவமற்ற வாழ்க்கை-ஓட்டம் துண்டிக்கப்பட்டு, புதிய கர்மப் பொருளைச் செயல்படுத்தும்படி கட்டாயப்படுத்தப்படுகிறது.', hi: 'अवरुद्ध भवंग: अरूप जीवन-धारा कट जाती है, जिसे नए कर्म वस्तु को संसाधित करने के लिए मजबूर किया जाता है।' } },
